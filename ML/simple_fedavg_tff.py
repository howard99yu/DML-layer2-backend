...
def build_federated_averaging_process(
  ...
  def run_one_round(server_state, federated_dataset):
    ...
    cw = client_outputs.client_weight
    mo = client_outputs.model_output
    return server_state, aggregated_outputs, cw, mo
